...
namespace BSFramework.Tools
{
    ...
    public static class LuaHelper
    {
        ...
        public static Component GetComponent(Transform trans, string classname)
        {
            System.Type t = GetType(classname);
            return GetComponent(trans, t);
        }

        public static Component GetComponent(Transform trans, System.Type t)
        {
            Component comp = null;
            if (trans != null && t != null) comp = trans.GetComponent(t);
            return comp;
        }
        ...
        public static Component AddComponent(Transform trans, string className)
        {
            System.Type t = GetType(className);
            return AddComponent(trans, t);
        }

        public static Component AddComponent(Transform trans, System.Type t)
        {
            Component comp = null;
            comp = GetComponent(trans, t);
            if (comp == null) comp = trans.gameObject.AddComponent(t);
        ...
        public static void RemoveComponent(Transform trans, string className)
        {
            Component comp = GetComponent(trans, className);
            if (comp != null) RemoveComponent(comp);
        }
        ...
        public static Component[] GetComponents(Transform trans, string classname)
        {
            System.Type t = GetType(classname);
            return GetComponents(trans, t);
        }

        public static Component[] GetComponents(Transform trans, System.Type t)
        {
            Component[] comp = null;
            if (trans != null && t != null) comp = trans.GetComponents(t);
            return comp;
        }
        ...
        public static Component[] GetComponentsInChildren(Transform trans, string classname)
        {
            System.Type t = GetType(classname);
            return GetComponentsInChildren(trans, t);
        }

        public static Component[] GetComponentsInChildren(Transform trans, System.Type t)
        {
            if (t != null && trans != null) return trans.GetComponentsInChildren(t);
            return null;
        }

        public static Component Find(GameObject obj, string childname)
        {
            return obj.transform.Find(childname);
        }

        public static Component FindChild(GameObject obj, string childname)
        {
            return obj.transform.FindChild(childname);
        }

        public static Component FindChild(Transform t, string childname)
        {
            return t.FindChild(childname);
        }

        public static Component FindChildIsComponent(GameObject obj, string childname, string classname)
        {
            return GetComponent(FindChild(obj, childname).gameObject, classname);
        }

        public static Component FindChildIsComponent(Transform t, string childname, string classname)
        {
            return GetComponent(FindChild(t.gameObject, childname).gameObject, classname);
        }

        public static Component[] GetComponentsInChildren(GameObject obj, string childname, string classname)
        {
            return GetComponentsInChildren(FindChild(obj, childname).gameObject, classname);
        }

        public static Component[] GetComponentsInChildren(Transform t, string childname, string classname)
        {
            return GetComponentsInChildren(FindChild(t.gameObject, childname).gameObject, classname);
        }
