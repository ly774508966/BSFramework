...
if (not __IsDeclared("Declare")) or (not Declare) then
    __Declare("Declare", __Declare)
end

-- Set "IsDeclared" into global.
if (not __IsDeclared("IsDeclared")) or (not IsDeclared) then
    __Declare("IsDeclared", __IsDeclared)
end
