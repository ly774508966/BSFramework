...
public class Lua_LeanTween : LuaObject {
	...
	static public int moveSpline_s(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(LTSpline),typeof(float))){
				UnityEngine.GameObject a1;
				checkType(l,1,out a1);
				LTSpline a2;
				checkType(l,2,out a2);
	...
	static public int value_s(IntPtr l) {
		try {
			...
			else if(matchType(l,argc,1,typeof(UnityEngine.GameObject),typeof(System.Action<UnityEngine.Color,object>),typeof(UnityEngine.Color),typeof(UnityEngine.Color),typeof(float))){
				UnityEngine.GameObject a1;
				checkType(l,1,out a1);
				System.Action<UnityEngine.Color,System.Object> a2;
				LuaDelegation.checkDelegate(l,2,out a2);
				UnityEngine.Color a3;
				checkType(l,3,out a3);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_maxSimulataneousTweens(IntPtr l) {
		try {
			pushValue(l,true);
			pushValue(l,LeanTween.maxSimulataneousTweens);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"maxSimulataneousTweens",get_maxSimulataneousTweens,null,false);
