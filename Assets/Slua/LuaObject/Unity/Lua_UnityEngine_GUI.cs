...
public class Lua_UnityEngine_GUI : LuaObject {
	...
	static public int Label_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(UnityEngine.Rect),typeof(UnityEngine.GUIContent))){
				UnityEngine.Rect a1;
	...
	static public int Toggle_s(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(UnityEngine.Rect),typeof(bool),typeof(UnityEngine.GUIContent))){
				UnityEngine.Rect a1;
				checkValueType(l,1,out a1);
				System.Boolean a2;
				checkType(l,2,out a2);
			...
			else if(matchType(l,argc,1,typeof(UnityEngine.Rect),typeof(bool),typeof(string))){
				UnityEngine.Rect a1;
				checkValueType(l,1,out a1);
				System.Boolean a2;
				checkType(l,2,out a2);
	...
	static public int Toolbar_s(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(UnityEngine.Rect),typeof(int),typeof(UnityEngine.GUIContent[]))){
				UnityEngine.Rect a1;
				checkValueType(l,1,out a1);
				System.Int32 a2;
				checkType(l,2,out a2);
			...
			else if(matchType(l,argc,1,typeof(UnityEngine.Rect),typeof(int),typeof(System.String[]))){
				UnityEngine.Rect a1;
				checkValueType(l,1,out a1);
				System.Int32 a2;
				checkType(l,2,out a2);
	...
	static public int SelectionGrid_s(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(UnityEngine.Rect),typeof(int),typeof(UnityEngine.GUIContent[]),typeof(int))){
				UnityEngine.Rect a1;
				checkValueType(l,1,out a1);
				System.Int32 a2;
				checkType(l,2,out a2);
			...
			else if(matchType(l,argc,1,typeof(UnityEngine.Rect),typeof(int),typeof(System.String[]),typeof(int))){
				UnityEngine.Rect a1;
				checkValueType(l,1,out a1);
				System.Int32 a2;
				checkType(l,2,out a2);
	...
	static public int Slider_s(IntPtr l) {
		try {
			...
			var ret=UnityEngine.GUI.Slider(a1,a2,a3,a4,a5,a6,a7,a8,a9);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int Window_s(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(int),typeof(UnityEngine.Rect),typeof(UnityEngine.GUI.WindowFunction),typeof(UnityEngine.GUIContent))){
				System.Int32 a1;
				checkType(l,1,out a1);
				UnityEngine.Rect a2;
			...
			else if(matchType(l,argc,1,typeof(int),typeof(UnityEngine.Rect),typeof(UnityEngine.GUI.WindowFunction),typeof(string))){
				System.Int32 a1;
				checkType(l,1,out a1);
				UnityEngine.Rect a2;
				checkValueType(l,2,out a2);
