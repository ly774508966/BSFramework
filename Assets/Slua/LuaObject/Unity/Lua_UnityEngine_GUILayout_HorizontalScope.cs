...
public class Lua_UnityEngine_GUILayout_HorizontalScope : LuaObject {
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.GUILayout.HorizontalScope");
		createTypeMetatable(l,constructor, typeof(UnityEngine.GUILayout.HorizontalScope),typeof(UnityEngine.GUI.Scope));
	}
}
